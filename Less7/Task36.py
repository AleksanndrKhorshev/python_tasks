...
def print_operation_table(operation, num_rows, num_columns):
    max_value = operation(num_rows, num_columns)
    ...
    for i in range(1, num_rows + 1):
        ...
        for j in range(1, num_columns + 1):
            ...
            formatted_element = '{:{width}}'.format(element, width=max_width)
            row.append(formatted_element)
        print(" ".join(row))


# Ввод числа строк и столбцов пользователем
